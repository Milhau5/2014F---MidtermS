...
public:
	...
	*/
	...
	CalculateSpherePosition
		Will modify the m_m4Creeper member so it updates the position of the Creeper in the specified trajectory for this test
	*/
	void CalculateSpherePosition(void);
